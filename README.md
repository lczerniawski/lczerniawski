<h1 align="center">Hi 👋, I'm Łukasz <img src="https://user-images.githubusercontent.com/74038190/212284087-bbe7e430-757e-4901-90bf-4cd2ce3e1852.gif" width="50"></img></h1>
<p align="center">Junior Architect at AXA and AI Student at University of Liverpool</p>
<p align="center">
  <a href="https://www.linkedin.com/in/lczerniawski/">
...
| -------------------- | -------------------------------------------- | --------- | --------- |
| [Obsidian Sunset VSCode Theme](https://github.com/lczerniawski/ObsidianSunset) | Obsidian Sunset is a dark and colorful theme for Visual Studio Code that enhances the readability and aesthetics of your code.  | [![VSCode Marketplace](https://img.shields.io/visual-studio-marketplace/v/lczerniawski.obsidiansunset)](https://marketplace.visualstudio.com/items?itemName=lczerniawski.obsidiansunset) | [![VSCode Marketplace](https://img.shields.io/visual-studio-marketplace/i/lczerniawski.obsidiansunset)](https://marketplace.visualstudio.com/items?itemName=lczerniawski.obsidiansunset) |
| [Git Unused Branch Cleaner VSCode Extension](https://github.com/lczerniawski/Git-Unused-Branch-Cleaner-VSCode) | The Git Unused Branch Cleaner extension helps developers and teams manage Git branches efficiently by identifying and cleaning up unused or outdated branches. | [![VSCode Marketplace](https://img.shields.io/visual-studio-marketplace/v/lczerniawski.git-unused-branch-cleaner)](https://marketplace.visualstudio.com/items?itemName=lczerniawski.git-unused-branch-cleaner) | [![VSCode Marketplace](https://img.shields.io/visual-studio-marketplace/i/lczerniawski.git-unused-branch-cleaner)](https://marketplace.visualstudio.com/items?itemName=lczerniawski.git-unused-branch-cleaner) |
| [Unused CSS Finder](https://github.com/lczerniawski/Unused-CSS-Finder) | Unused CSS Finder is a Visual Studio Code extension that helps you identify and remove unused CSS classes from your project. It scans your files, finds unused CSS, and marks it as a problem directly in the editor. | [![VSCode Marketplace](https://img.shields.io/visual-studio-marketplace/v/lczerniawski.unused-css-finder)](https://marketplace.visualstudio.com/items?itemName=lczerniawski.unused-css-finder) | [![VSCode Marketplace](https://img.shields.io/visual-studio-marketplace/i/lczerniawski.unused-css-finder)](https://marketplace.visualstudio.com/items?itemName=lczerniawski.unused-css-finder) |
| [Angular File Toggle](https://github.com/lczerniawski/Unused-CSS-Finder) | The Angular File Toggle extension for Visual Studio Code allows you to quickly switch between different file types (TypeScript, HTML, CSS) in Angular projects. | [![VSCode Marketplace](https://img.shields.io/visual-studio-marketplace/v/lczerniawski.angular-file-toggle)](https://marketplace.visualstudio.com/items?itemName=lczerniawski.angular-file-toggle) | [![VSCode Marketplace](https://img.shields.io/visual-studio-marketplace/i/lczerniawski.angular-file-toggle)](https://marketplace.visualstudio.com/items?itemName=lczerniawski.angular-file-toggle) |
| [Obsidian Sunset JetBrains Theme](https://github.com/lczerniawski/ObsidianSunset-JetBrains) | Obsidian Sunset is a dark and colorful theme for JetBrains IDE that enhances the readability and aesthetics of your code.  | [![JetBrains Marketplace](https://img.shields.io/jetbrains/plugin/v/obsidiansunset?label=version)](https://plugins.jetbrains.com/plugin/23938-obsidian-sunset-theme) | [![JetBrains Marketplace](https://img.shields.io/jetbrains/plugin/d/obsidiansunset)](https://plugins.jetbrains.com/plugin/23938-obsidian-sunset-theme) |
